...
## Project Structure
    ...
    ├── balance_tran_app_v2_2  # Django project configurations
...
1. Clone this repo and `cd balance_tran_app_v2_2`
...
2. Clone this repo and `cd balance_tran_app_v2_2`
